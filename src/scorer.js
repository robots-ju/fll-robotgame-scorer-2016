...
(function(sc) {
	...
	sc.warnings = Object.freeze({
		m01_cannot_score_bonus_alone:  'm01_cannot_score_bonus_alone',
		m01_cannot_score_both_options: 'm01_cannot_score_both_options',
		m06_cannot_score_both_options: 'm06_cannot_score_both_options',
		m10_cannot_score_both_options: 'm10_cannot_score_both_options',
		m11_cannot_score_both_options: 'm11_cannot_score_both_options',
	...
	sc.computeMissions = function(missions)
	{
		...
		*/
		...
		var m01_target1 = missions.hasOwnProperty('m01_tank_and_shark_in_target1') && missions.m01_tank_and_shark_in_target1;
		var m01_target2 = missions.hasOwnProperty('m01_tank_and_shark_in_target2') && missions.m01_tank_and_shark_in_target2;
		...
		if (missions.hasOwnProperty('m01_shark_not_touching_wall') && missions.m01_shark_not_touching_wall)
		{
			...
			if (m01_target1 || m01_target2) {
				...
				warnings.push(sc.warnings.m01_cannot_score_bonus_alone);
			}
		}
		...
		if (m01_target1 && m01_target2)
		{
			 ...
			 */
			warnings.push(sc.warnings.m01_cannot_score_both_options);
		}
		...
		*/
		...
		var m06_option1 = missions.hasOwnProperty('m06_milk_and_manure_out') && missions.m06_milk_and_manure_out;
		var m06_option2 = missions.hasOwnProperty('m06_milk_only_out') && missions.m06_milk_only_out;
		...
		if (m06_option1 && m06_option2)
		{
			 ...
			 * the official PDF
			 */
			warnings.push(sc.warnings.m06_cannot_score_both_options);
		}
		...
		*/
		...
		var m10_option1 = missions.hasOwnProperty('m10_bee_on_beehive') && missions.m10_bee_on_beehive;
		var m10_option2 = missions.hasOwnProperty('m10_bee_on_beehive_and_honey_in_base') && missions.m10_bee_on_beehive_and_honey_in_base;
		...
		if (m10_option1 && m10_option2)
		{
			 ...
			 */
			warnings.push(sc.warnings.m10_cannot_score_both_options);
		}
		...
		*/
		...
		var m11_option1 = missions.hasOwnProperty('m11_prosthesis_fitted') && missions.m11_prosthesis_fitted;
		var m11_option2 = missions.hasOwnProperty('m11_prosthesis_fitted_and_in_farm') && missions.m11_prosthesis_fitted_and_in_farm;
		...
		if (m11_option1 && m11_option2)
		{
			 ...
			 * > Only one option counts.
			 */
			warnings.push(sc.warnings.m11_cannot_score_both_options);
		}
